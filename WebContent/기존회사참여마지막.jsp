...
.accont-wrap{ margin-top:200px;margin-bottom:200px;}
.with-account {
    padding: 6px 0 16px;
    font-size: 36px;
    color: #333;
...
.join-backgroundimage {
    background: url(https://flow.team/flow-renewal/assets/images/none_member.png) no-repeat;
    width: 157px;
    height: 141px;
...
.join-start-button:hover{background: #0085D0;}
em, i {
    font-style: normal;
}
...
<body>
	<header class="with-header main">
		...
		<div class="accont-wrap" style="display:block;">
			<div class="with-account" id="waitCompanyName">
				<%=company_name %>
			</div>
			<div class="join-text-bold" id="waitCompanyUrl">
				<%=company_url %>
			</div>
			<div class="join-basic-wrap">
				...
				<a href="메인.html" class="join-start-button">
					메인 페이지 이동
				</a>
			</div>
		</div>
