			...
			$.ajax({
				...
				success: function(abc){
					...
					if(timeOver==false){
						...
						let pw = $("#password").val();
						location.href="login?send_num=9&id="+email+"&pw="+pw+"&name="+name+"&job="+job+"&company_id="+company_id+"&company_url="+company_url+"&company_name="+company_name;
					}else{
						alert("시방 뭔일이래");
					}
				}
