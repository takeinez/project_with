...
<%
	...
	String id = (String) session.getAttribute("loginId1");
	//	String A = (String) session.getAttribute("A");
	System.out.println("왔나"+id);
	//	System.out.println("왔나"+A);
%>
...
<!-- 						            <h3 data="with-down-hstr" class="with-admin-menu with-down-hstr">파일 다운로드 이력</h3> -->
					...
					<div id="additionalInfo">
						<a href="사용자매뉴얼.html" target="help" rel="noopener noreferrer" class="admin-menual-btn" style="text-decoration:underline #fff;">
