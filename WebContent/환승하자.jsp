...
<%
	...
	session.setAttribute("loginId1", loginId);
	System.out.println(loginId+"로그인한 아이디!");
%>
<!DOCTYPE html>
<html>
<head>
...
<link href="css/ddddd.css" rel="stylesheet">
<link href="css/openProject.css" rel="stylesheet">
...
<script src="js/takein.js"></script>
<script src='fullcalendar/main.js'></script>
<script src='js/mainProjectAjex.js'></script>
  ...
  document.addEventListener('DOMContentLoaded', () => {
	...
	$(document).ready(function () {
	 ...
	 document.addEventListener("DOMContentLoaded", function () {
		  ...
		  const changePositionOk = document.querySelector("#settingCmpnTlphNo .change-ok");
		  ...
		  const position = document.querySelector("#settingCmpnTlphNo .js-phone-number");
		  const editorPosition = document.querySelector("#settingCmpnTlphNo #editor_phoneNum");

		  function validatePhoneNumberInput(inputElement) {
			    const inputValue = inputElement.value.trim();
			    const regex = new RegExp(/^[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}/); // 전화번호 형식
			    const errorMessage = document.querySelector("#settingCmpnTlphNo #error-message");
		  ...
		  changePositionOk.addEventListener("click", (e) => {
			    ...
			    if (validatePhoneNumberInput(editorPosition)) { // 입력 값이 올바른 경우에만 저장
			        position.textContent = editorPosition.value.trim();
			        readModePosition.classList.remove("d-none");
			        readModePosition.classList.add("d-block");
			        editorModePosition.classList.remove("d-block");
	 ...
	 $('.flow-pop-sub-button-2').click(function() {
	      const selectedColorCode = $('.project-color-check-active-1').attr('class').replace('color-item ', '').replace(' project-color-check-active-1', '');
	      $('#projectColor').removeClass().addClass(`project-color ${selectedColorCode}`);
	      $('.flow-all-background-1').removeClass('d-none');
...
<div class= "main-top">
	<header class="header">
		...
		<div class="main-search-area cursor-pointer">
            ...
            <div id="searchPopupLayer" class="name-type-seach-popup" data-search-area-code="IN_TONG" style="top: 5px; right: 30%; display: none;">
                <div class="search-popup-header">
                    <div class="search-popup-input">
                        ...
                        <input id="searchPopupInput" type="text" class="name-type-shift-txt" maxlength="20" autocomplete="off" placeholder="검색어를 입력해주세요">
                        </div>
                ...
                <div class="js-search-section-div">
                    <p>
                        카테고리
                    <i class="fa-solid fa-circle-info" id="icon"></i>
                    </p>
                    <ul class="section-name-list">
                        <li data-code="project" class="js-search-section section-name-type-1">
                            <a href="#">
                                <div class="section-name-icon-1"></div>
                                <span class="js-section-name">프로젝트</span>
                                <!--<span>(Alt + P)</span>-->
                            </a>
                        </li>
                        <li data-code="post" class="js-search-section section-name-type-2">
                            <a href="#">
                                <div class="section-name-icon-2"></div>
                                <span class="js-section-name">글 · 댓글</span>
                                <!--<span>(Alt + W)</span>-->
                            </a>
                        </li>
                        ...
                        <ul class="conditions-group">
                            <li class="js-project-name-search-filter" style="display: none">
                                ...
                                <div class="condition-cell">
                                    <input type="text" style="width:100%;" placeholder="프로젝트명을 입력하세요">
                                </div>
                            </li>
                            <li class="js-register-name-search-filter" style="display: none">
                                <div class="condition-cell title">작성자</div>
                                <div class="condition-cell">
                                    <input type="text" style="width:100%;" placeholder="작성자명 입력 (여려명 입력시, 콤마로 구분)">
                                </div>
                            </li>
                            <li class="js-participant-name-search-filter" style="display: none">
                                <div class="condition-cell title">참여자</div>
                                <div class="condition-cell">
                                    <input type="text" style="width:100%;" placeholder="참여자명 입력 (여려명 입력시, 콤마로 구분)">
                                </div>
                            </li>
                            <li class="js-period-type-search-filter" data-code="unlimit" style="display: block;">
                                <div class="condition-cell title">
                                    기간 설정
                                </div>
                                <div class="condition-cell" style="width:auto;">
                                    <ul class="target-select-group">
             <li>
                <input id="전체" type="radio" name="period-type" class="radio-input " data-code="unlimit" data="">
                <label for="전체" class="js-period-type radio-label-checkbox" data-code="unlimit">전체</label>
            </li>
        
            <li>
                <input id="오늘" type="radio" name="period-type" class="radio-input " data-code="today" data="">
                <label for="오늘" class="js-period-type radio-label-checkbox" data-code="today">오늘</label>
            </li>
        
            <li>
                <input id="7일" type="radio" name="period-type" class="radio-input " data-code="week" data="">
                <label for="7일" class="js-period-type radio-label-checkbox" data-code="week">7일</label>
            </li>
        
            <li>
                <input id="1개월" type="radio" name="period-type" class="radio-input " data-code="month" data="">
                <label for="1개월" class="js-period-type radio-label-checkbox" data-code="month">1개월</label>
            </li>
        
            <li>
                <input id="3개월" type="radio" name="period-type" class="radio-input " data-code="thirdMonth" data="">
                <label for="3개월" class="js-period-type radio-label-checkbox" data-code="thirdMonth">3개월</label>
            </li>
        
            <li>
                <input id="6개월" type="radio" name="period-type" class="radio-input " data-code="sixthMonth" checked="">
                <label for="6개월" class="js-period-type radio-label-checkbox" data-code="sixthMonth">6개월</label>
            </li>
        
            <li>
                <input id="1년" type="radio" name="period-type" class="radio-input " data-code="year" data="">
                <label for="1년" class="js-period-type radio-label-checkbox" data-code="year">1년</label>
            </li>
        
            <li>
                <input id="기간선택" type="radio" name="period-type" class="radio-input js-date-select-input" data-code="select" data="">
                <label for="기간선택" class="js-period-type radio-label-checkbox" data-code="select">기간선택</label>
            <div class="search-period-wr">
                <div class="js-search-pickr-layer" id="calender" style="display:none;">
 					  <p><input type="text" id="datepicker1" style="border: 1px solid black; width:80px; float:left; border-radius:5px;">&nbsp; ~  &nbsp;
					    <input type="text" id="datepicker2" style="border: 1px solid black;width:80px; float:right; border-radius:5px;"></p>
                </div>
            </div>
                            ...
                            <li class="js-tmpl-type-search-filter" style="display: block;">
                                ...
                                <div class="condition-cell">
                                    <ul class="target-select-group">
            <li>
                <input id="전체" type="radio" name="tmpl-type" class="radio-input" data-code="0" checked="">
                <label for="전체" class="js-tmpl-type radio-label-checkbox" data-code="0">전체</label>
            </li>
        
            <li>
                <input id="글" type="radio" name="tmpl-type" class="radio-input" data-code="1" data="">
                <label for="글" class="js-tmpl-type radio-label-checkbox" data-code="1">글</label>
            </li>
        
            <li>
                <input id="업무" type="radio" name="tmpl-type" class="radio-input" data-code="4" data="">
                <label for="업무" class="js-tmpl-type radio-label-checkbox" data-code="4">업무</label>
            </li>
        
            <li>
                <input id="일정" type="radio" name="tmpl-type" class="radio-input" data-code="3" data="">
                <label for="일정" class="js-tmpl-type radio-label-checkbox" data-code="3">일정</label>
            </li>
        
            <li>
                <input id="할 일" type="radio" name="tmpl-type" class="radio-input" data-code="2" data="">
                <label for="할 일" class="js-tmpl-type radio-label-checkbox" data-code="2">할 일</label>
            </li>
        
            <li>
                <input id="투표" type="radio" name="tmpl-type" class="radio-input" data-code="5" data="">
                <label for="투표" class="js-tmpl-type radio-label-checkbox" data-code="5">투표</label>
            </li>
        
            <li>
                <input id="댓글" type="radio" name="tmpl-type" class="radio-input" data-code="-1" data="">
                <label for="댓글" class="js-tmpl-type radio-label-checkbox" data-code="-1">댓글</label>
            </li>
        </ul>
                                </div>
                            </li>
                       ...
                       <div class="condition-button-area">
                            <div class="condition-left"style="float: left; margin-left: 20px;">
                                <button type="button" class="js-filter-reset condition-reset">
                                    초기화
                                </button>
                            </div>
                            <div class="condition-right" style="margin-right: 20px; float: right;">
                                <button class="js-filter-cancel condition-button cancel" onclick="closePopup1()">취소</button>
        ...
        <div id="rightTopMenu" class="top-btns">
                    &lt;
<!--             <button type="button" id="organizationTopButton" class="btn-organization js-mouseover js-button-tooltip" style="display: inline-block;"onclick= "openPopup()"> -->
<!--                 <i class="fa-solid fa-sitemap" style="color: #ffffff; font-size:25px;"></i> -->
<!--             </button> -->
<!--             <button type="button" id="chattingTopButton" class="btn-chatting js-mouseover js-button-tooltip" style="margin: 0 10px;" onclick= "openPopup1()">  -->
<!--                <i class="fa-regular fa-comment" style="color: #ffffff; font-size:25px;"><span></span></i> -->
<!--                 <i id="chatTopCount" class="label-chat" style="display: none">0</i> -->
<!--             </button> -->
<!--             <button type="button" id="alarmTopButton" class="btn-alarm js-mouseover -->
<!--             js-button-tooltip"  onclick= "openPopup9()"> -->
<!--                 <i class="fa-regular fa-bell" style="color: #ffffff; font-size:25px;"></i> -->
<!--                 <i id="alarmTopCount" class="label-alarm" style="display: none;">10</i> -->
<!--             </button> -->
            
            <button type="button" id="accountTopButton" class="btn-profile" style="margin-left: 15px;" onclick="openPopup11()">
                <span id="ProfileImg" class="profile-area" style="background-image: url('https://flow.team/flowImg/FLOW_202306151753937_52d2d9aa-b7a4-42ea-8a2a-b67fbb46c7b0.png?width=400&height=400')"></span>
            </button>
        </div>
        
        <ul id="accountLayer" class="modal-account d-none" style="display: none;">
            <li class="user-area">
                <p class="js-profile user-img" style="background-image: url('https://flow.team/flowImg/FLOW_202306151753937_52d2d9aa-b7a4-42ea-8a2a-b67fbb46c7b0.png?width=400&amp;height=400&');"></p>
                <div class="user-info">
                    <strong class="js-user-name js-mouseover">박형근</strong>
                    <span class="js-version">비즈니스 프로 버전</span>
                </div>
            </li>
            ...
            <li id="mySettingOpenBtn" onclick='openPopup13()'>
                <i class="fa-solid fa-gear" style="color: #000000;"></i>
                환경설정
            </li>
            <li id="desktopDownloadBtn" class="download-desktop" href="https://flow.team/main.act">
	...
	<article id="organizationLayer" class="side-wr d-none" style="display: none;">
    <section id="orgChartGuide" class="guest-upgrade-organization" style="display: flex;">
        <button id="OrganCloseBtn" class="btn-close" onclick="openPopup()">
            <i class="fa-solid fa-x"></i>
        </button>
        <div>
            <strong>조직도</strong>
            <p>조직도를 만들고<br>직원들을 관리해 보세요!</p>
            
                <a href="https://support.flow.team/hc/ko/articles/4727122046489" target="_blank">자세히 알아보기</a>
            <form action="https://flow.team/flow_admin.act?MENU=flow-org-management">
            <button id="makeOrgChart">조직도 생성</button>
            </form>
        </div>
    </section>
</article>	
<article id="chattingLayer" class="side-wr d-none" style="display: none;">
    <div class="menu-top">
        <strong class="js-menu-txt">채팅</strong>
        <button type="button" class="js-allChat-alarm alarm on js-mouseover js-button-tooltip"><i class="icon-alarm"></i></button>
        <button id="chatCloseBtn" class="btn-close" onclick="openPopup1()">
            <i class="fa-solid fa-x"></i>
        </button>
    </div>
    <div class="side-contents">
        <ul id="chatTabMenu" class="tab-menu" style="display: flex; padding-left: 17px;">
        ...
        <div class="all-setup-type-2">
            ...
            <input id="chattingSearchInput" type="text" class="all-setup-input-type-1" placeholder="이름, 채팅방명 검색" autocomplete="off">
            <button class="js-input-del btn-search-delete absolute-r r-28" style="display: block;">
            <i></i>
            </button>
        </div>
    </div>
...
<article id="alarmLayer" class="side-wr d-none" style="display: none;">
    ...
    <div class="side-contents">
        ...
        <!-- 알림 리스트 -->
        <div class="all-setup-type-2">
            <i class="fa-solid fa-magnifying-glass" id="glass2" style="color: #050505;"></i>
            <input id="alarmSearchInput" type="text" class="all-setup-input-type-1" placeholder="검색" autocomplete="off">

            <div class="x-option-wrap">
                <button class="js-input-del btn-search-delete" style="display: none;">
                    <i></i>
                </button>
                <a href="#" id="alarmSearchFilterTopButton" class="all-setup-detail-text-1" onclick="openPopup10()">옵션</a>
            </div>
            <div id="alarmSearchFilterLayer" class="popup-filter-type-1 d-none" style="display:none;">
                <div class="js-project-title js-filter-item setup-detail-type-1" data-num="0">
                    <a href="#">
                        <em onclick="changeClass()"></em>
                        <span style="color: #6449fc;">프로젝트명</span>
                    </a>
                </div>
                <div class="js-contents js-filter-item setup-detail-type-1" data-num="1">
                    <a href="#">
                        <em onclick="changeClass1()"></em>
                        <span style="color: #6449fc;">내용</span>
                    </a>
                </div>
                <div class="js-register-id js-filter-item setup-detail-type-1" data-num="2">
                    <a href="#">
                        <em onclick="changeClass2()"></em>
                        <span style="color: #6449fc;">작성자</span>
                    </a>
                </div>
            </div>
        </div>
...
<div class="back-area temp-popup" id="postPopup2" style="position: absolute;right: 0;height: 100%; display:none;">
	<div class="with-project-make-1 back-area">
		<div class="with-project-make-2 back-area contents">
				<div class="card-item post-card-wrapper schedule side">
					<div class="post-popup-header card-popup-header">
						<h3 class="card-popup-title">
							<i id="projectTitleColor" class="project-color color-4"></i>
							<span class="project-title-button">에에</span>
						</h3>
					...
					<div class="post-card-header">
						<div class="post-card-scroll" style="transition:max-height 0.5s ease 0s, min-height 0.5 ease 02;">
							<div class="card-header-top">
								<div class="post-author" data-author-id="">
									<span class="thumbnail size40 radius16" style="background-image:url(https://flow.team/flow-renewal/assets/images/profile-default.svg)"></span>
									<dl class="post-author-info">
										<dt>
											<strong class="author  notranslate">정택인</strong>
											<em class="position " style="display:inline;"></em>
											<span class="date">2023-07-14</span>
											<span class="post-security" style="display:inline;">
								...
								<div>
									<div class="post-option">
										<button id="movePost" class="btn-go" style="display:inline-block">
											게시글 바로가기
										</button>
							...
							<div class="card-header-bottom sticky-title">
								<div class="schedule-date">
									<strong class="schedule-month">2023-07</strong>
									<strong class="schedule-day">01</strong>
								</div>
								<div class="post-title-area">
									<h4 class="post-title">밭갈기</h4>
									<div class="schedule-period-area">
										<span class="schedule-period-start">2023-07-01, 09:30</span>
										<span class="schedule-period-end" style="display:inline-block;">2023-07-31, 10:50</span>
									</div>
								</div>
							</div>
								...
								<div id="originalPost" class="post-card-content" style="display:block">
									<div class="post-card-content">
										<ul class="create-content-group">
											<li class="js-attendance-layer" style="position:relative;  ">
												<div class="create-content-cell title manager" style="display:inline-block;">
													<i class="icon-post-worker"></i>
												</div>
												<div class="create-content-cell manager-btn-group" style="display:inline-block;">
													<div class="user-wrap">
														<span class="js-manager-group manager-group">
														</span>
													</div>
													<button type="button" class="add-manager-button" style="display:none">
														참석자 변경
													</button>
									...
									<div id="attendanceSelect" class="attendance-button-group" style="display:block;">
										<button class="attendance-button participate " data-status="participate">참석</button>
										<button class="attendance-button absence " data-status="absence">불참</button>
										<button class="attendance-button undetermined " data-status="undetermined">미정</button>
									</div>
								</div>
								<div class="post-bottom-area" style="height:20px;">
									<div class="post-bottom-menu">
										<div class="bottom-button-area">
											<button class="post-bottom-button love">
												<i class="icon-reaction"></i>
												<span>좋아요</span>
												<span id="love_count">1</span>
											</button>
											<button class="post-bottom-button bookmark">
							...
							<div class="post-card-footer">
								<div class="comment-header">
									<button type="button" class="comment-more-button on">
							...
							<div class="comment-input-wrap">
								<div class="comment-thumbnail">
									<span class="thumbnail size40 radius16" style="background-image: url(https://i.ibb.co/bzCQC2Q/image.jpg?width=400&height=400)">
								</div>
								<form class="comment-container on">
									<fieldset style="padding-top:0;">
										<input type="text" class="comment-input" placeholder="댓글을 입력하세요.">
										<button id="comment-btn-final" type="button" style="border: 1px solid; border-radius: 5px;height: 40px; width: 50px;">입력</button>
									</fieldset>
...
<div id="leftArea" class="main-header-1" style="float:left;">
    <div id="leftTask" class="left-task active" style="padding-bottom: 32px;">
        ...
        <ul id="leftMenuUl" class="menu-group js-left-menu mgt-20">
            <li data-code="main" class="my-project left-menu-item">
                        <a href="#">
                            <i class="fa-solid fa-house" style="color: #ffffff; margin-right:10px;"></i>내 프로젝트
                        </a>
                    </li>
                <li data-code="open" id="glass" class="left-menu-item">
                        <a href="#" style="margin-left:23px;">
                            	회사 공개 프로젝트</a>
                    </li>
                <li data-code="nokeep" id="menu1" class="left-menu-item d-none" style="display:none;">
                <a href="#"><i class="fa-regular fa-envelope-open" style="color: #ffffff;margin-right:10px;"></i>미분류</a>
            </li>
            <li data-code="unread" id="menu2" class="left-menu-item d-none" style="display:none;">
                <a href="#"><i class="fa-regular fa-envelope" style="color: #ffffff; margin-right:10px;"></i>미확인
                </a>
            </li>
            <li data-code="star" id="menu3" class="left-menu-item d-none" style="display:none;">
                <a href="#"><i class="fa-regular fa-star" style="color: #ffffff; margin-right:10px;"></i>즐겨찾기</a>
            </li>
            <li data-code="hidden" id="menu4" class="left-menu-item d-none" style="display:none;">
                <a href="#"><i class="fa-regular fa-eye-slash" style="color: #ffffff; margin-right:8px;"></i>숨김</a>
            </li>
            <li class="js-project-more-button left-menu-item" data-code="project-more" onclick="openPopup2()">
                <a href="#">
                    <span style="font-size:15px;">&#x22EE</span>&nbsp;&nbsp;&nbsp;&nbsp;더보기</a>
                    
                <ul class="js-project-more-layer check-menu-popup left-more-menu d-none" id="plus" style="display:none;">
                    <li>
                        <button data-code="nokeep" id="item1" type="button" class="left-menu-item"style="display:block;" onclick="openPopup3()">
                            <i class="fa-regular fa-envelope-open" style="color: #999;margin-right:5px;"></i>미분류</button>
                    </li>
                    <li>
                        <button data-code="star" id="item3"type="button" class="left-menu-item"style="display:block;" onclick="openPopup5()">
                            <i class="fa-regular fa-star" style="color: #999; margin-right:5px;"></i>즐겨찾기</button>
                    </li>
                    <li>
                        <button data-code="hidden" id="item4"class="left-menu-item"style="display:block;" onclick="openPopup6()">
                            <i class="fa-regular fa-eye-slash" style="color: #ccc; margin-right:4px;"></i>숨김</button>
                    </li>
                </ul>
            </li>
        </ul>
        ...
        <ul id="leftScroll" class="menu-accordion-group scroll-mask thin">
            <li>
                <div class="menu-accordion-button active left-menu-item" data-code="collect-more">
                    모아보기<i class="fa-solid fa-angle-up" style="color:#ccc; margin-left:100px;" onclick="openPopup7()"></i>
                </div>
                <div class="menu-accordion" style="display: block; margin-left:30px;">
                    <ul class="menu-accordion-list" id="menu11">
<!--                         <li data-code="task" class="left-menu-item"> -->
<!--                             <a href="#"><i class="fa-solid fa-list-ul" style=" font-size:18px; color: #999; margin-right:10px;"></i>전체 업무</a> -->
<!--                         </li> -->
<!--                         <li data-code="gantt" class="left-menu-item"> -->
<!--                             <a href="#"><i class="fa-solid fa-bars-staggered" style="font-size: 18px;color: #999; margin-right:10px;"></i>간트차트</a> -->
<!--                         </li> -->
                        <li data-code="schd" class="left-menu-item">
                                <a href="#">
                                    <i class="fa-regular fa-calendar" style="font-size: 18px;color: #999; margin-right:12px;"></i>캘린더</a>
                            </li>
<!--                         <li data-code="file" class="left-menu-item"> -->
<!--                                 <a href="#"><i class="fa-solid fa-box-archive" style="font-size: 18px;color: #999; margin-right:10px;"></i>파일함</a> -->
<!--                             </li> -->
                            <li data-code="bookmark" class="left-menu-item">
                                <a href="#"><i class="fa-regular fa-bookmark" style="font-size: 18px;color: #999; margin-right:13px;"></i>북마크</a>
                            </li>
                            <li data-code="mention" class="left-menu-item">
                                <a href="#"><span style="font-size:15px;">@</span>&nbsp;&nbsp;&nbsp;나를 언급</a>
                            </li>
                            <li data-code="mypost" class="left-menu-item">
                                <a href="#"><i class="fa-solid fa-chalkboard-user" style="font-size: 18px;color: #999; margin-right:9px;"></i>내 게시물</a>
                            </li>
                        <li data-code="tmpPost" class="left-menu-item">
                            <a href="#"><i class="fa-solid fa-file-circle-exclamation" style="font-size: 18px;color: #999; margin-right:9px;"></i>임시저장</a>
                        </li>
                    </ul>
                </div>
            </li>
            <li style="display: block;">
                    <div id="RecentProjectButton" class="menu-accordion-button left-menu-item active" data-code="recent-project-more">
                        최근 업데이트<i class="fa-solid fa-angle-up" style="color:#ccc; margin-left:73px;" onclick="openPopup8()"></i>
                    </div>
            ...
            <li>
                <div id="allLabelLeftButton" data-code="label-more" class="menu-accordion-button active">
                    프로젝트 폴더<button class="js-label-add label-add-button">
                        <i class="fa-solid fa-plus" style="color:red;"></i>
                    </button>
                    <i class="fa-solid fa-angle-up" style="color:#ccc; margin-left:40px;" onclick="openPopup14()"></i>
                </div>
                <div class="menu-accordion">
                    <div class="bg-type lnb"  style="border-bottom: 1px solid #434149;">
        ...
        <div class="js-label-setting-layer setting-popup flow-small-layer-1 cursor-pointer" style="display: none">
        ...
        <ul id="leftBottomUl" class="menu-group admin">
            <li data-code="invite-member" class="js-invite-employee-button left-menu-item invite-btn">
                    <a href="#"><i class="fa-solid fa-people-group" style="color: #999; margin-right:10px;"></i>직원 초대</a>
                </li>
            <li data-code="manager-admin" class="left-menu-item admin-btn">
                    <a href="#"><i class="fa-solid fa-user-gear" style="color: #999; margin-right:10px;"></i>어드민</a>
                </li>
        </ul>
        </div>
</div>
...
<div id="topSettingBar" class="main-header" style="display: block">
    <div id="mainTop" class="title-1" style="display: block;" data-code="detail"><div>내 프로젝트</div></div>
    <div id="allCollectionCount" class="js-collection-total-count js-collection-count top-task-num" style="display: none;">9</div>
    <div id="projectHomeTop" class="main-sub-header" style="display:block;">
   		<div class="home-menu clearfix">
   			<div class="home-menu-left">
   				<a href="#">
   					<div id="BoardTypeButton" class="menu-select-icon-type-1 type-button on"></div>
   				</a>
   				<a href="#">
   					<div id="ListTypeButton" class="menu-select-icon-type-2 type-button"></div>
   				</a>
   			</div>
   			<div class="home-menu-right">
   				<a href="#" id="projectOrderButton" class="project-order-button">
   					<div id="projectOrderList" class="menu-popup-layer-1" style="display:none;">
   						<ul class="menu-popup-t-1">
   							<li class="order-item on" code="0">
	   							<i></i>
	   							<span>최신 순(글/댓글)</span>
   							</li>
   						...
   						<ul class="menu-popup-t-2">
                            <li class="filter-item on" code="0"><i></i><span>내가 참여중인 프로젝트</span></li>
...
<div class="project-header-group">
	...
	<button id="openInviteLayerBtn" type="button"
		class="project-invite-button color-code-1" style="display: none;">
	...
	<div class="top-banner-2">
		<ul id="totalEditButton" class="total-edit-group">
            <li class="edit-button color">
            	<a href="#" class="top-banner-icon-type-1">
                	<em></em>색상 설정
                </a>
            </li>
            <li class="edit-button label">
            	<a href="#" class="top-banner-icon-type-2">
                	<em></em>프로젝트 폴더 설정
                </a>
            </li>
            <li class="edit-button push">
            	<a href="#" class="top-banner-icon-type-3">
                	<em></em>알림 설정
                </a>
            </li>
            <li class="edit-button hidden" style="display: inline-block;">
            	<a href="#" class="top-banner-icon-type-4">
                	<em></em>숨김
                </a>
            </li>
            <li class="edit-button hidden2" style="display: none;">
            	<a href="#" class="top-banner-icon-type-4">
                	<em></em>숨김 취소
                </a>
            </li>
...
<div id="mainContent" class="main-content scroll-mask" style="display: block;" scroll-direction="0">
	<div id="projectHomeLayer" class="project-home-wrap" style="display:block;min-height:100%;">
		<div class="small-style-wrap">
			<div id="projectContentsLayer" class="section-wrap">
		...
		<div class="open-search-area">
			<div class="project-search-area all-file-header-type-3">
				<div class="project-search">
					<i class="fa-solid fa-magnifying-glass" style="display:inline;position:relative;top:4px;right:6px;"></i>
					<input id="openProjectSearchInput" type="text" placeholder="검색어를 입력해주세요" class="project-search-input">
					<button class="btn-search-delete absolute-r" style="display:none;">
						<i style="left: -6px;top: -1px;position: relative;"></i>
					</button>
				</div>
			</div>
		</div>
			...
			<div class="section-wrap">
				<div class="section-2">
					<div class="public-title-area">
						<span id="openProjectCategoryName" class="public-project-title">전체</span>
						<em id="openProjectTotalCount" class="public-count">2</em>
					</div>
				</div>
				<div id="openProjectScroll" class="layer-scroll type4">
					<ul id="openProjectList" class="section-list-1 project-list-setion">
	...
	<div id="allCollectView" class="all-collect-wrap d-none" style="height:100%;display:none">
		<div id="mainScroll" class="main-scroll padding-left-right-30 type3">
			<div class="allCalendarLayer full-width small-style-wrap-2 d-none ko" style="display:flex;">
				<div id='calendar' ></div>
			</div>
		</div>
	</div>
	
	<div id="allPostsLayer" class="me-post-wrap layer-scroll d-none" data-code="bookmark" style="display:none;">
		<div class="my-search-area">
			<div class="project-search-area all-file-header-type-3">
				<div class="project-search">
					<i class="fa-solid fa-magnifying-glass" style="position: absolute;top: 17px;left: -5px;"></i>
					<input id="allPostsSearchInput" class="project-search-input" type="text" placeholder="검색어를 입력해주세요">
					<div class="x-option-wrap">
						<button class="btn-search-delete" style="display:none;">
							<i style="left: -6px;position: relative;top: -1px;"></i>
						</button>
						<button id="allPostsDetailSearchTopButton" type="button" class="search-set-button">
							옵션
						</button>
					</div>
					<div id="allPostsDetailSearchLayer" class="name-type-seach-popup d-none" style="top: 40px;left: 0px;display: none;">
						<p>옵션</p>
						<div class="detail-search-conditions">
							<ul class="conditions-group">
								<li style="display:block;">
								...
								<li data-code="" style="display:block;">
									<div class="condition-cell title" style="float:left;">검색기간</div>
									<div class="condition-cell">
										<ul class="target-select-group">
											<li>
												<input id="ex1" type="radio" name="period-type" class="radio-input" data-code="unlimit">
												<label for="ex1" class="radio-label-checkbox" data-code="unlimit">
												전체
												</label>
											</li>
											<li>
												<input id="ex2" type="radio" name="period-type" class="radio-input" data-code="today">
												<label for="ex2" class="radio-label-checkbox" data-code="today">
												오늘
												</label>
											</li>
											<li>
												<input id="ex3" type="radio" name="period-type" class="radio-input" data-code="week">
												<label for="ex3" class="radio-label-checkbox" data-code="week">
												7일
												</label>
											</li>
											<li>
												<input id="ex4" type="radio" name="period-type" class="radio-input" data-code="month">
												<label for="ex4" class="radio-label-checkbox" data-code="month">
												1개월
												</label>
											</li>
											<li>
												<input id="ex5" type="radio" name="period-type" class="radio-input" data-code="thirdMonth">
												<label for="ex5" class="radio-label-checkbox" data-code="thirdMonth">
												3개월
												</label>
											</li>
											<li>
												<input id="ex6" type="radio" name="period-type" class="radio-input" data-code="sixthMonth">
												<label for="ex6" class="radio-label-checkbox" data-code="sixthMonth">
												6개월
												</label>
											</li>
											<li>
												<input id="ex7" type="radio" name="period-type" class="radio-input" data-code="year">
												<label for="ex7" class="radio-label-checkbox" data-code="year">
												1년
												</label>
											</li>
								...
								<li data-code="" style="display:block;">
									<div class="condition-cell title" style="float:left;">대상</div>
									<div class="condition-cell">
										<ul class="target-select-group">
											<li>
												<input id="exe1" type="radio" name="tmpl-type" class="radio-input" data-code="unlimit">
												<label for="exe1" class="radio-label-checkbox" data-code="0">
												전체
												</label>
											</li>
											<li>
												<input id="exe2" type="radio" name="tmpl-type" class="radio-input" data-code="today">
												<label for="exe2" class="radio-label-checkbox" data-code="1">
												글
												</label>
											</li>
											<li>
												<input id="exe3" type="radio" name="tmpl-type" class="radio-input" data-code="week">
												<label for="exe3" class="radio-label-checkbox" data-code="2">
												업무
												</label>
											</li>
											<li>
												<input id="exe4" type="radio" name="tmpl-type" class="radio-input" data-code="month">
												<label for="exe4" class="radio-label-checkbox" data-code="3">
												일정
												</label>
											</li>
											<li>
												<input id="exe5" type="radio" name="tmpl-type" class="radio-input" data-code="thirdMonth">
												<label for="exe5" class="radio-label-checkbox" data-code="4">
												할일
												</label>
											</li>
											<li>
												<input id="exe6" type="radio" name="tmpl-type" class="radio-input" data-code="sixthMonth">
												<label for="exe6" class="radio-label-checkbox" data-code="5">
												투표
												</label>
											</li>
											<li>
												<input id="exe7" type="radio" name="tmpl-type" class="radio-input" data-code="year">
												<label for="exe7" class="radio-label-checkbox" data-code="6">
												댓글
												</label>
											</li>
							...
							<div class="condition-button-area">
								<div class="condition-left">
									<button type="button" class="condition-reset" style="display: none;">초기화</button>
								</div>
								<div class="condition-right">
									<button class="condition-button cancel">취소</button>
                                	<button class="condition-button search">검색</button>
								</div>
							</div>
						</div>
					</div>
				</div>
				<button type="button" class="result-back-button d-none">
			...
			<div class="feed-content me-content">
				<div class="search-title-area">
					...
					<div id="allPostsFilter" class="me-filter-area" style="display:block;">
	                    ...
	                    <ul class="check-menu-popup my-popup" style="display:none;position:absolute;top:39px;right:-3px;">
	                    	<li>
	                            <div class="check-menu-item on" data-code="0" style="margin-bottom:10px;">전체</div>
	                        </li>
	                        <li>
	                            <div class="check-menu-item" data-code="1" style="margin-bottom:10px;">글</div>
	                        </li>
	                        <li>
	                            <div class="check-menu-item" data-code="2" style="margin-bottom:10px;">업무</div>
	                        </li>
	                        <li>
	                            <div class="check-menu-item" data-code="3" style="margin-bottom:10px;">일정</div>
	                        </li>
	                        <li>
	                            <div class="check-menu-item" data-code="4" style="margin-bottom:10px;">할 일</div>
	                        </li>
	                        <li>
	                            <div class="check-menu-item" data-code="5" style="margin-bottom:10px;">투표</div>
	                        </li>
	                        <li>
	                            <div class="check-menu-item" data-code="-1" style="display: none;">댓글</div>
	                        </li>
	                    </ul>
					</div>
				</div>
				<ul id="myPostContentUl" class="all-seach-list-type-1 post-group scroll-mask">
...
<div id="detailLayer" class="main-sub-header project-detail-wrap" style="display: block;">
<div class="project-detail-top default-tab clearfix" style="display:none;padding-bottom:10px;">
...
<!-- 					</li> -->
			...
			<!-- 여기까진 문제가 없었는데 말입니다 이게 참... 어이가 없네 참나.. 이게 맞나 싶어서 마음이 아프지만 그래도 넘어가야지 뭐 어쩌겠어 그것이 인생이니까 아 인생이여 이것이 답이다! -->
										...
										<div class="taks-report">
											...
											<ul id="taskReportLayer" class="donut-chart-list">
												<li><span class="task-chart-info request" data-code="0">
														...
														<i class="chart-info-label"></i> <span
														class="chart-info-text"><span>진행</span><em><%=d%></em></span>
...
<div class="with-all-background-1 back-area temp-popup" style="display:none;">
	<div class="with-project-make-1 back-area">
		<div class="with-project-make-2 back-area contents">
			<div class="color-popup2 with-project-popup-3 d-none" style="display:none;">
				<div class="with-project-header-1">
					프로젝트 색상
					<a class="cursor-pointer close-event with-close-type-1"></a>
				</div>
				<div class="with-content">
					<div class="with-category-option-3">
						<ul id="selectColorTypes" class="select-color-group">
							<li class="color-item project-color-type-5" color-code="5">
								<a class="cursor-pointer"><em></em></a>
							</li>
	                        <li class="color-item project-color-type-11" color-code="11">
	                        	<a class="cursor-pointer"><em></em></a>
	                        </li>
	                        <li class="color-item project-color-type-1" color-code="1">
	                        	<a class="cursor-pointer"><em></em></a>
	                        </li>
	                        <li class="color-item project-color-type-10" color-code="10">
	                        	<a class="cursor-pointer"><em></em></a>
	                        </li>
	                        <li class="color-item project-color-type-2" color-code="2">
	                        	<a class="cursor-pointer"><em></em></a>
	                        </li>
	                        <li class="color-item project-color-type-7" color-code="7">
	                        	<a class="cursor-pointer"><em></em></a>
	                        </li>
	                        <li class="color-item project-color-type-9" color-code="9">
	                        	<a class="cursor-pointer"><em></em></a>
	                        </li>
	                        <li class="color-item project-color-type-6" color-code="6">
	                        	<a class="cursor-pointer"><em></em></a>
	                        </li>
	                        <li class="color-item project-color-type-3" color-code="3">
	                        	<a class="cursor-pointer"><em></em></a>
	                        </li>
	                        <li class="color-item project-color-type-4" color-code="4">
	                        	<a class="cursor-pointer"><em></em></a>
	                        </li>
	                        <li class="color-item project-color-type-8" color-code="8">
	                        	<a class="cursor-pointer"><em></em></a>
	                        </li>
	                        <li class="color-item project-color-type-0" color-code="0">
	                        	<a class="cursor-pointer"><em></em></a>
	                        </li>
						</ul>
					</div>
					<div class="with-pop-button-type-1 margin-bottom-20">
						<button type="button" class="with-pop-sub-button-1 cancel-event">취소</button>
						<button type="button" class="with-pop-sub-button-2 submit-event">확인</button>
					</div>
				</div>
			</div>
			<div class="label-popup2 allProjLabel-popup with-project-popup-8" style="display: none;">
	            <div class="with-project-header-1">
	                <span>프로젝트 폴더 설정</span>
	                <a class="cursor-pointer close-event with-close-type-1"></a>
	            </div>
	            <ul class="label-set-group scroll-mask" style="display:block;">
				    
				</ul>
	            <div class="with-pop-button-type-2">
	                <a class="cursor-pointer">
	                    <div class="with-pop-sub-button-1 cancel-event">취소</div>
	                </a>
	                <a class="cursor-pointer">
	                    <div class="with-pop-sub-button-2 submit-event">확인</div>
	                </a>
	            </div>
        	</div>
        	<div class="push-alarm-popup2 allProjPushAlarm-popup with-project-popup" style="display:none;">
        		<div class="with-project-header-1">
        			알림 설정
        			<a class="cursor-pointer close-event with-close-type-1"></a>
        		</div>
        		<div class="with-content push-alarm-content">
        			<div id="pushSettingContents">
        				<dl class="alarm-popup-set push">
        					<dt>
        					...
        					<dd>
        						...
        						<select class="push-selected ps1">
        							<option data="0">모두받기</option>
        							<option data="1">나와 관련된 알림만 받기</option>
        							<option data="2">받지 않기</option>
        						</select>
        					</dd>
        						<div class="set-subtitle">댓글 푸시</div>
        						<select class="push-selected ps2">
        							<option data="0">모두받기</option>
        							<option data="1">내가 참여한 글의 댓글 알림</option>
        							<option data="2">내가 작성한 글의 댓글 알림</option>
        							<option data="3">나를 언급한 글의 댓글 알림</option>
        						</select>
        				</dl>
        				<dl class="alarm-popup-set alarm">
        					<dt>
        						<span class="set-title alarm">
        						알림 리스트 설정
        						</span>
        					</dt>
        					<dd class="cursor-pointer">
        						<span>모두받기</span>
        						<input type="radio" name="alarm" id="allAlarm" class="radio-input">
        						<label for="allAlarm" class="radio-label">
        						</label>
        					</dd>
        					<dd class="cursor-pointer">
        						<span>나와 관련된 알림만 받기</span>
        						<input type="radio" name="alarm" id="relatedAlarm" class="radio-input">
        						<label for="relatedAlarm" class="radio-label"></label>
 	     					</dd>
        				</dl>
        			</div>
        		</div>
        		<div class="with-pop-button-type-1" style="margin-top:20px;">
        			<a class="cursor-pointer">
	        			<div class="with-pop-sub-button-1 cancel-event">취소</div>
        			</a>
        			<a class="cursor-pointer">
        	...
        	<div class="confirm-popup2 with-project-popup-6 d-none" style="display:none;">
        		<div class="with-content">
        			<div class="with-content-text">
        				<dt class="popup-title"></dt>
        				<p class="popup-cont">선택한 프로젝트를 숨기시겠습니까?</p>
        			</div>
        			<div class="with-pop-button-type-1">
	        				<div class="with-pop-sub-button-1 cursor-pointer cancel-event">취소</div>
		        			<div class="with-pop-sub-button-2 cursor-pointer submit-event">확인</div>
        			</div>
        		</div>
        	</div>
		</div>
...
<!--여기 프로필  -->
<div class="flow-all-background-1 back-area temp-popup" tabindex="0" id="tempPopup" style="z-index: 11; display:none;">
            <div class="flow-project-make-1 back-area "><div class="flow-project-make-2 back-area contents"> <div class="profile-popup js-profile-popup d-none" style="display: block;">
        <div class="profile-header">
            <div class="profile-header-dimmed-layer"></div>
            <button class="btn-close icons-close-1" onclick="openPopup12()"><i class="fa-solid fa-x" style="color: #000000; font-size:15px;"></i>
</button>
        </div>
        <div class="name-card name-badge">
            <i class="profile-image js-profile-image " style="background-image: url(https://flow.team/flowImg/FLOW_202306151753937_52d2d9aa-b7a4-42ea-8a2a-b67fbb46c7b0.png?width=400&amp;height=400), url(https://flow.team/flowImg/FLOW_202306151753937_52d2d9aa-b7a4-42ea-8a2a-b67fbb46c7b0.png), url(/flow-renewal/assets/images/profile-default.svg)" data=""></i>
            <!--프로필 사진 미설정 시 .default 클스 추가-->
            <div class="info profile-badge">
                <p class="info-box">
                    <span class="name ellipsis">박형근</span>
                    <span class="position"></span>
                </p>
                <p class="info-badge d-none">
</p>
            </div>
        </div>
        <div class="contact-section scroll-mask thin">
            <ul class="contact-contents">
                <li class="company-info">
                    <em><i class="profile-company"></i></em>
                    <div>
                        <strong>오하늘닷컴</strong>
                        <em></em>
                    </div>
                </li>
                <li id="profileDayOffNm" style="display:none" data="">
                    <em><i class="profile-now"></i></em>
                    <span>-</span>
                </li>
                <li id="profileEmpNd" style="display:none" data="">
                    <em><i class="profile-num"></i></em>
                    <span>-</span>
                </li>
                <li id="profileChargeJobNm" style="display:none" data="">
                    <em><i class="profile-task"></i></em>
                    <span>-</span>
                </li>
                <li id="profileFmcNo" style="display:none" data="">
                    <em><i class="icon-Icon-profile-fmc js-user-phone"></i></em>
                    <span>-</span>
                </li>
                <li id="profileEml" style="display:flex" data="">
                    <em><i class="profile-mail js-user-email"></i></em>
                    <span>hkbk00@gmail.com</span>
                </li>
                <li id="profileClphNo" class=" " style="display:flex" data="">
                    <em><i class="profile-phone js-user-phone"></i></em>
                    <span class="profileClphNo">-</span>
                </li>
                <li id="profileExtNo" style="display:none" data="">
                    <em><i class="icon-Icon-profile-office js-user-call"></i></em>
                    <span>-</span>
                </li>
                <li id="profileCmpnTlphNo" class="" style="display:flex" data="" title="">
                    <em><i class="profile-call js-user-call"></i></em>
                    <span>-</span>
                </li>
                <li id="profileWorkingTime" style="display:none" data="">
                    <em><i class="profile-worktime"></i></em>
                    <span>-</span>
                </li>
                <li id="profileSlgn" class="txt" style="display:flex" data="">
                    <em><i class="profile-txt icon-txt js-user-txt"></i></em>
                    <span =""="" class="scroll-mask thin">-</span>
                </li>
            </ul>
        </div>
        <div class="btn-wr column">
            <button class="btn-chat js-btn-chat">
                ...
                <button class="btn-modi js-btn-modi" style="display:flex" onclick='openPopup13(),openPopup12()'>
                    <span>정보수정</span>
                    <i></i>
                </button>
            </div>
            ...
            <div id="innerMySettingPopup" class="my-layer-type-3">
                <div class="my-layer-header">
                    <div class="my-layer-header-1">
                        <div id="myPicture" class="my-prop-picture" style="background-image: url(&quot;https://flow.team/flowImg/FLOW_202306151753937_52d2d9aa-b7a4-42ea-8a2a-b67fbb46c7b0.png?width=400&amp;height=400&quot;), url(&quot;/flow-renewal/assets/images/profile-default.png&quot;);">
                    ...
                    <div id="editorProfilePhoto" class="my-popup-pro-1-1 d-none">
                        <a id="changeProfilePhotoBtn" href="#">
                            <span>
                                <i class="icons-picture"></i>
                                사진 변경
                            </span>
                        </a>
                        <a id="removeProfilePhotoBtn" href="#">
                            <span>
                    ...
                    <a href="#" id="mySettingPopupCloseBtn" class="my-button-close-1" onclick="openPopup13()"></a>
                </div>
                <div class="my-layer-content">
                    <div class="my-left-style">
                        <ul class="my-popup-left-header" id="mySettingLeftMenu">
                            <li class="js-my-setting-left"><a id="accountSettingBtn" href="#"><em class="my-color-type-2"></em><em class="my-type-text-2">계정</em></a>
                            </li>
                            <li class="js-my-setting-left"><a id="preferencesBtn" href="#"><em class="my-color-type-1"></em><em class="my-type-text-1">알림</em></a>
                            </li>
                            <li class="js-my-setting-left"><a id="projectSettingBtn" href="#"><em class="my-color-type-1"></em><em class="my-type-text-1">디스플레이 설정</em></a>
                            </li>
                            <li class="js-my-setting-left"><a id="deviceManagementBtn" href="#"><em class="my-color-type-1"></em><em class="my-type-text-1">보안
                            </em></a>
                            </li>
                        </ul>
                    </div>
...
<div id="accountSettingLayer" class="js-my-scroll-layer my-over-style d-block">
    <div class="my-right-style adjust">
        ...
        <ul>
            ...
            <li>
                ...
                <div id="user_id" class="my-right-list-2">hkbk00@gmail.com</div>
            </li>
            <li class="edit-input js-flnm-set adjust" id="settingFlnm">
            <div class="my-right-list-1">이름</div>
            <div class="read-mode d-block">
                <div class="js-user-name my-right-list-2">박형근</div>
            </div>
            <a href="#" class="poly-icon-1 change-editor-btn"></a>
            <div class="editor-mode d-none">
                <div class="my-right-list-2 my-type-text-1">
                    <input id="editor_user_name" type="text" maxlength="20" autocomplete="off" data-required-yn="Y" data-valid="name" data-empty-msg="이름을 입력해주세요!" data-un-valid-msg="특수문자를 사용할 수 없습니다">
                    ...
                    <div class="btn-fr-wrap">
                        ...
                        <a href="#">
                            <div class="js-account-set-button js-account-set-button my-button-ok change-ok"> 확인</div>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <li class="edit-input js-company-set adjust" id="settingCmnm">
                    ...
                    <div class="read-mode d-block">
                        <div id="companyName" class="my-right-list-2">오하늘닷컴</div>
                    </div>      
            </li>
    ...
    <div class="read-mode d-block">
        <div id="position" class="js-position-name my-right-list-2"></div>
        <a href="#" class="poly-icon-1 change-editor-position-btn"></a>
    </div>
    <div class="editor-mode d-none">
        <div class="my-right-list-2 my-type-text-1">
            <input id="editor_position" type="text" autocomplete="off" maxlength="50">
            <div class="btn-fr-wrap">
                <a href="#">
                    <div class="my-button-cc cancel-position-change">취소</div>
                </a>
                <a href="#">
                    <div class="js-position-set-button my-button-ok change-position-ok">확인</div>
                </a>
            </div>
        </div>
    </div>
</li>
            <li class="edit-input js-clph-no-set adjust" id="settingClphNo" style="display: flex;">
                
                    
                        <div class="my-right-list-1">휴대폰 번호
                        </div>
                <div class="read-mode d-block">
                    <div id="phoneNum" class="js-phone-number my-right-list-2"></div>
                    <a href="#" class="poly-icon-1 change-editor-btn"></a>
                </div>
                <div class="editor-mode d-none">
                    <div class="my-right-list-2 my-type-text-1">
                                <input id="editor_phoneNum" type="text" autocomplete="off" data-valid="phoneNumber" maxlength="20" placeholder="숫자와  -만 입력 가능합니다" data-un-valid-msg="전화번호 형식이 맞지 않습니다." style="min-width: 150px;">
                        <span id="error-message" class="error-message" style="display:none; color: red;"></span>
                        <div class="btn-fr-wrap">
                            <a href="#">
                                <div class="my-button-cc cancel-change">취소</div>
            ...
            <li class="edit-input js-email-set adjust" id="settingEml" style="display: flex;">
                <div class="my-right-list-1">이메일</div>
                <div class="read-mode d-block">
                    <div id="email" class="my-right-list-2">hkbk00@gmail.com</div>
                    
                </div>
            </li>

            <li class="edit-input adjust password" id="passwordArea" style="display: flex;">
                <div class="my-right-list-1">비밀번호</div>
                <div class="read-mode d-block">
                    <div class="my-right-list-password">
                        <strong class="password-alert">비밀번호 재설정이 가능합니다.</strong>
                        <input type="password" id="normalPasswordInput" class="my-input-password-1 d-none" disabled="" placeholder="비밀번호 입력 (8~20자 영문, 숫자, 특수문자 조합)" style="display: flex;">
                        <button class="js-myset-password change-editor-btn">비밀번호 재설정</button>
                    </div>
                </div>
                <div class="editor-mode d-none">
                    <ul>
                        <li>
                            ...
                            <div class="my-right-list-2 edit-password"><a href="#"></a><span class="my-txt-t-1">비밀번호는 영문, 숫자, 특수문자 포함 8자리 이상이어야 합니다.</span>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="my-right-list-2">
                                ...
                                <input type="password" id="currentPassword" class="my-input-password-2" style="margin-left:5px" autocomplete="off" data-required-yn="Y" maxlength="20" data-valid="password" data-empty-msg="비밀번호를 입력해주세요" data-over-msg="20자 이내로 입력하세요." data-un-valid-msg="비밀번호는 8~20자의 영문, 숫자, 특수문자를 포함해야 합니다." placeholder="현재 비밀번호를 입력해주세요"></div>
                        </li>
                        <li>
                            <div class="my-right-list-1"></div>
                            <div class="my-right-list-2">
                                <span class="edit-tit">새 비밀번호</span>
                                <input type="password" id="myPassword" class="my-input-password-2" style="margin-left:8px" autocomplete="off" data-required-yn="Y" maxlength="20" data-valid="password" data-empty-msg="비밀번호를 입력해주세요" data-over-msg="20자 이내로 입력하세요." data-un-valid-msg="비밀번호는 8~20자의 영문, 숫자, 특수문자를 포함해야 합니다." placeholder="새 비밀번호를 입력해주세요"></div>
                        </li>
                        <li>
                            <div class="my-right-list-1"></div>
                            <div class="my-right-list-2">
                                <span class="edit-tit">비밀번호 확인</span>
                                <input type="password" class="my-input-password-2" style="margin-left:5px" id="myPassword2" autocomplete="off" data-required-yn="Y" maxlength="20" data-valid="password" data-empty-msg="비밀번호를 입력해주세요" data-over-msg="20자 이내로 입력하세요." data-un-valid-msg="비밀번호는 8~20자의 영문, 숫자, 특수문자를 포함해야 합니다." placeholder="비밀번호를 다시 입력해주세요"></div>
                        </li>
                        <li>
                            <div class="btn-fr-wrap password-btn-fr-wrap"><a href="#">
            ...
            <li class="edit-input js-slgn-set adjust" id="settingSlgn" style="display: flex;">
                <div class="my-right-list-1">상태 메시지</div>
                <div class="read-mode d-block">
                    <div id="statusMessage" class="my-right-list-2 status-message"></div>
        ...
        <div class="setting-layer-bottom-wrap clearFix">
            ...
            <button id="marketingAgreementBtn" class="btn-setting-layer-bottom">혜택 알림 동의 변경</button>
            
            <button id="leaveFlowBtn" class="btn-setting-layer-bottom" style="display: none;">탈퇴</button>
        </div>
    </div>
</div>

<div id="preferencesLayer" class="alarmSet js-my-scroll-layer my-over-style d-none">
  <div class="my-right-style">
    ...
    <ul id="doNotDisturbGroup" class="disturb-group">
      ...
      <li>
        ...
        <div class="my-right-list-2 sp-between disturb-day" id="notDisturbDailyList">
          <span>요일</span>
          <div id="doNotDisturbDayby">
            <ul class="my-dayby-w-1">
              <li id="0dayOfTheWeek" class="my-dayby-1 day-of-the-week"><a href="#">일</a></li>
              <li id="1dayOfTheWeek" class="my-dayby-1 day-of-the-week"><a href="#">월</a></li>
              <li id="2dayOfTheWeek" class="my-dayby-1 day-of-the-week"><a href="#">화</a></li>
              <li id="3dayOfTheWeek" class="my-dayby-1 day-of-the-week"><a href="#">수</a></li>
              <li id="4dayOfTheWeek" class="my-dayby-1 day-of-the-week"><a href="#">목</a></li>
              <li id="5dayOfTheWeek" class="my-dayby-1 day-of-the-week"><a href="#">금</a></li>
              <li id="6dayOfTheWeek" class="my-dayby-1 day-of-the-week"><a href="#">토</a></li>
            </ul>
          </div>
        </div>
      </li>
    ...
    <ul class="js-mail-set-ul email-alarm-set">
      <li class="bd-none">
        <div class="my-right-list-1">이메일 알림
          
            
              <a href="https://support.flow.team/hc/ko/articles/7578317732377" target="_blank"><i class="question-mark"></i></a>
      ...
      <li>
        ...
        <div class="my-right-list-2 js-mail-set-text">
          누군가가 나를 @멘션 합니다.
          <button type="button" id="mentionMailButton" class="js-mail-set-button toggle-button my-check-1" mail-set-type="mail_mention">
            <i class="handle"></i>
          </button>
        </div>
      </li>
      <li>
        ...
        <div class="my-right-list-2 js-mail-set-text">
          누군가가 내게 업무를 배정합니다.
          <button type="button" id="workerMailButton" class="js-mail-set-button toggle-button my-check-1" mail-set-type="mail_worker">
            <i class="handle"></i>
          </button>
        </div>
      </li>
      <li>
        ...
        <div class="my-right-list-2 js-mail-set-text">
          ...
          <button type="button" id="taskMailButton" class="js-mail-set-button toggle-button my-check-1" mail-set-type="mail_task">
            <i class="handle"></i>
          </button>
        </div>
      </li>
      <li>
        <div class="my-right-list-1"></div>
        <div class="my-right-list-2 js-mail-set-text weekly-report-icon">
          주간 리포트
          <button id="weekReportMailButton" class="js-mail-set-button toggle-button my-check-1" mail-set-type="mail_week_report" type="button">
            <i class="handle"></i>
          </button>
        </div>
      </li>
...
<div id="deviceManagementLayer" class="securitySet js-my-scroll-layer my-over-style d-none">
        ...
        <div class="my-right-style">
            <ul class="lock-list">
                ...
                <li>
                    ...
                    <div class="my-right-list-2 sp-between">
                        시간 설정
                        <select id="lockTime" class="my-type-4">
                            <option value="1">
                             1분 후
                            </option>
                            <option value="5">
                ...
                <li class="bd-none">
                    ...
                    <div class="my-right-list-2 sp-between">
                        <ul id="deviceList" class="my-right-data d-none">
                            <li class="sp-between">
                                <div>
                                    <p class="data-position-fix-1"><b> {DUID_NM}</b></p>
                                    <p class="data-color-type-1"><b>마지막 사용</b><span> {LAST_DATE}</span></p>
                                    <p class="data-color-type-1"><b>최초 등록일</b><span> {FIRST_DATE}</span></p>
                                </div>
                                <div>
                                    <a id="removeDevice" duid="{DUID}" href="#" class="data-delete-button-1 remove-btn {DISPLAY_REMOVE}">
                                        <div>삭제</div>
                                    </a>
                                    <div class="wifi-icon-wrap-1 {DISPLAY_CURRENT}">
                                        <div class="wifi-icon-1">
                                        </div>
                                        <span>현재 접속기기</span>
                                    </div>
                                </div>
...
<div id="projectSettingsLayer" class="js-my-scroll-layer my-over-style d-none">
    <div class="my-right-style">
            ...
            <li>
                ...
                <div id="themeSetting" class="my-right-list-2 set-theme">
                    <div class="my-right-check-dark">
                        ...
                        <p>다크</p>
                        <div id="darkThemeSetting" class="my-check-2 theme-posion-fix" style="right:50%;"></div>
                    </div>
                    <div class="my-right-check-light">
                        <div class="my-right-check-light-icon" style="margin-left:50px;"></div>
                        <p>라이트</p>
                            <div id="lightThemeSetting" class="my-check-2 theme-posion-fix" style="right:0%;"></div>
                    </div>
                </div>
            </li>
        </ul>
        ...
        <ul>
            <li class="bd-none">
                ...
                <div class="my-right-list-2">프로젝트 만들기 또는 초대 받았을때, 프로젝트의 색상을 지정합니다.</div>
            </li>
            <li>
                <div class="my-right-list-1"></div>
                <div class="my-right-list-2 sp-between">
        ...
        <ul>
            <li class="my-setting-favorite-project bd-none">
                ...
                <div class="my-right-list-2 sp-between">프로젝트 즐겨찾기 시, 상단에 고정하도록 설정할 수 있습니다.
                    <span id="starResetBtn" class="btn-reset"><a href="#" class="my-right-icon-type-1"></a>초기화</span>
                </div>
            </li>
            <li>
                <div class="my-right-list-1"></div>
            ...
            <li><div class="my-right-list-1"></div>
                <div class="my-right-list-2">
                    즐겨찾기 사용안함
                    <a href="#"><div id="notUseFavoritesSetting" class="my-check-2"></div></a>
                </div>
            </li>
        </ul>
    </div>
    ...
    <div class="flow-all-background-1 back-area temp-popup1 d-none" style="background: rgba(0,0,0,0.6); z-index: 10;">
    <div class="confirm-popup flow-project-popup-6 d-block">
            <div class="flow-content">
                <div class="flow-content-text">
                    <p class="popup-cont">프로젝트 즐겨찾기를 초기화 하시겠습니까?<br>(복구 되지 않습니다)</p>
                </div>
                <div class="flow-pop-button-type-1">
                        <div class="flow-pop-sub-button-1 cancel-event" style="cursor:pointer;">취소</div>
                        <div class="flow-pop-sub-button-2 submit-event" style="cursor:pointer;">확인</div>
                </div>
            </div>
        </div>
        </div>
        <div class="flow-all-background-1 back-area temp-popup2 d-none" style="background: rgba(0,0,0,0.6); z-index: 10;">
	        <div id="createLabel" class="input-popup flow-project-popup-4" style="display: block;">
	            <div class="flow-project-header-1"><span class="popup-title">프로젝트 폴더 만들기</span>
	            </div>
	            <div class="flow-content">
	                <div class="flow-content-input-1">	
	                    <input class="popup-input" type="text" placeholder=" 프로젝트 폴더명을 입력하세요" maxlength="50" data-required-yn="Y" data-empty-msg="" data-over-msg="프로젝트 폴더명을 50자 이하로 입력해주세요.">
	                </div>
	                <div class="flow-pop-button-type-1">
	                        <div class="flow-pop-sub-button-1 cancel-event1" style="cursor:pointer;">취소</div>
	                        <div class="flow-pop-sub-button-2 submit-event1" style="cursor:pointer;">확인</div>
	                </div>
	            </div>
	        </div>
        </div>
        <div class="flow-all-background-1 back-area temp-popup3 d-none" style="background: rgba(0,0,0,0.6); z-index: 10;">
	        <div id="firstInvitePopup" class="js-invite-employee-layer popup-notice-employee" style="display: block;">
	                <div class="contents">
	                    <strong class="tit">직원 초대</strong>
	                    <a class="close-invite-layer-btn js-close-btn" href="#"><em></em></a>
	                    <p class="txt">직원들과 협업을 시작해보세요.</p>
	                    <img src="https://flow.team/flow-renewal/assets/images/invite_url.png">
	                    ...
	                    <a id="otherInviteBtn" class="other-invite" style="display: block;">다른 방법으로 초대하기 (이메일, 엑셀 등록)</a>
	                </div>
         ...
         <div class="color-popup flow-project-popup-3">
            <div class="flow-project-header-1">프로젝트 색상<a class="cursor-pointer close-event flow-close-type-1"></a>
            </div>
            <div class="flow-content">
                <div class="flow-category-option-3">
                    <ul id="selectColorTypes" class="select-color-group">
                        <li class="color-item color-code-5"><a class="cursor-pointer"><em></em></a></li>
                        <li class="color-item color-code-11"><a class="cursor-pointer"><em></em></a></li>
                        <li class="color-item color-code-1 project-color-check-active-1"><a class="cursor-pointer"><em></em></a></li>
                        <li class="color-item color-code-10"><a class="cursor-pointer"><em></em></a></li>
                        ...
                        <li class="color-item color-code-9"style="margin-left: 0px;"><a class="cursor-pointer"><em></em></a></li>
         ...
         <div class="flow-all-background-1 label-popup d-none">
	         <div class="label-popup allProjLabel-popup flow-project-popup-8" >
	            <div class="flow-project-header-1">
	                <span>프로젝트 폴더 설정</span>
	                <a class="cursor-pointer close-event flow-close-type-1"></a>
	            </div>
	            <ul class="js-label-ul label-set-group scroll-mask">
				    <li class="label-item" data-label-kind="3" data-label-srno="6" data-label-ico="">
				        <div class="label-set-item" style="margin-top: 15px;">
				            <span class="label-item-text ellipsis">ㅁㄴㅇㅁㄴㅇㅁ</span>
				            <a href="#" class="js-check-label flow-content-check-type-1"></a>
				        </div>
				    </li>
				
				    <li class="label-item" data-label-kind="3" data-label-srno="5" data-label-ico="">
				        <div class="label-set-item">
				            <span class="label-item-text ellipsis">asd</span>
				            <a href="#" class="js-check-label flow-content-check-type-1"></a>
				        </div>
				    </li>
				
				    <li class="label-item" data-label-kind="3" data-label-srno="4" data-label-ico="">
				        <div class="label-set-item">
				            <span class="label-item-text ellipsis">aa</span>
				            <a href="#" class="js-check-label flow-content-check-type-1"></a>
				        </div>
				    </li>
				
				    <li class="label-item" data-label-kind="3" data-label-srno="1" data-label-ico="4">
				        <div class="label-set-item">
				    ...
				    <li class="label-item" data-label-kind="3" data-label-srno="2" data-label-ico="9">
				        <div class="label-set-item">
				            <span class="label-item-text ellipsis">디자인</span>
				            <a href="#" class="js-check-label flow-content-check-type-1"></a>
				        </div>
				    </li>
				
				    <li class="label-item" data-label-kind="3" data-label-srno="3" data-label-ico="1">
				        <div class="label-set-item">
				            <span class="label-item-text ellipsis">엔지니어링</span>
				            <a href="#" class="js-check-label flow-content-check-type-1"></a>
				        </div>
				    </li>
				</ul>
          ...
          <!-- 자잘자잘한 팝업 -->
            <div class="alert-wrap d-none" id="toastPopup" style="display: none;">
	            <div class="alert-type error">
	                <div class="text">프로젝트를 선택해주세요.</div>
	            </div>
	        </div>
	      ...
	      <div class="project-template-intro" style="display:none;"><!-- 파트1 -->
			<div>
				<section class="left">
					<h1>새 프로젝트를 만들어 보세요!</h1>
					<p>프로젝트를 어떻게 만들지 선택해보세요</p>
				</section>
				<section class="right">
					<button id="createProjectButton" class="button-create-template">프로젝트 만들기</button><br/>
					<a href="사용자매뉴얼.html">프로젝트 활용방법 확인하기</a>
				</section>
			</div>
		 </div>
	      
	      <article class="project-template-main" style="display:none;"><!-- 파트2 -->
		<header>
			<button id="templateReturnButton" class="button-go-back">
				<i class="fa-solid fa-arrow-rotate-left"></i>
				<span>뒤로</span>
			</button>
			<button id="projectSectionClose" class="button-close" >
				<i class="fa-solid fa-xmark"></i>
			</button>
		</header>
		<section>
			<div class="project-make-default">
				<div class="form-wrap">
					<h1>프로젝트 만들기</h1>
					<div class="template-create-cont">
						<div>
							<input id="projectTitleInput" type="text" placeholder="제목을 입력하세요.">
							<textarea id="projectContentsInput" placeholder="프로젝트에 관한 설명 입력 (옵션)" maxlength="10000"></textarea>
						</div>
						<div style="margin-top:10px;">
							<div>
								<div class="auth-setting-wrap">
									...
									<div style="float:right;" >
										...
										<label for="toggle" class="toggleSwitch" onclick="openCategory();" >
										  <span class="toggleButton"></span>
										</label>
									</div>
								</div>
								<div id="category" class="d-none company-category-option" style="display:none;">
									<div class="auth-setting-wrap">
										<span class="sub-tit">카테고리 설정</span>
										<div class="select-wrap">
											<select>
												<option id="catg_1" value="1">업무관련</option>
												<option id="catg_2" value="2">동호회</option>
												<option id="catg_3" value="3">정보공유</option>
												<option id="catg_4" value="4">학습</option>
											</select>
										</div>
									</div>
								</div>
								...
								<div class="auth-setting-wrap">
									...
									<div class="button-toggle-add-option" style="float:right;">
										<span id="openOption" onclick="openOp();">선택</span>
										<span id="closeOption" onclick="closeOp();" style="display:none;">닫기</span>
									</div>
								</div>
							</div>
							<div>
								<div id="addOption" class="add-option test_obj" style="display:none;">
									<h3>게시글</h3>
									<div style="height:100%;">
										<div class="project-option">
											<span>작성 권한</span>
											<div class="select-wrap">
												<select id = "writePermission" class="select-box">
													<option value="0">전체</option>
													<option value="1">프로젝트관리자만</option>
												</select>
											</div>
										</div>
										<div class="project-option">
											<span>수정 권한</span>
											<div class="select-wrap">
												<select id="modifyPermission" class="select-box">
										...
										<div class="project-option">
											<span>조회 권한</span>
											<div class="select-wrap">
												<select id = "viewPermission" class="select-box">
													<option value="0">전체</option>
													<option value="1">프로젝트관리자만</option>
												</select>
											</div>
										</div>
										<p class="add-option-info">* ex) 수정 권한을 모두로 설정하면 모든이가 나의 글을 수정할 수 있습니다. </p>
									<h3>댓글</h3>
										<div class="project-option">
											<span>작성 권한</span>
											<div class="select-wrap">
												<select id = "replyPermission" class="select-box">
													<option value="0">전체</option>
													<option value="1">프로젝트관리자만</option>
												</select>
											</div>
									...
									<h3>파일</h3>
										<div class="project-option">
											<span>조회/다운로드 </span>
											<div class="select-wrap">
												<select id="filePermission" class="select-box">
													<option value="0">전체</option>
													<option value="1">프로젝트관리자 + 작성자만</option>
												</select>
											</div>
										</div>
									</div>
								</div>
								<div id = "letsgogo" class="button-wrap">
								...
								<li id="editDateTimeArea"
									...
									<div class="create-content-cell">
										<div class="schedule-time">
											<div class="js-pickr-layer js-start-flatpickr">
													<input class="js-pickr-text schedule-input" id="pick1" type="text" readonly="">
											</div>
											<div class="js-pickr-layer js-end-flatpickr">
												<input class="js-pickr-text schedule-input" id="pick2" type="text" readonly="">
											</div>
											<div class="oneday">
								...
								<li>
									...
									<div class="create-content-cell">
										...
										<select id="alarmButton" class="alarm-select"><option
												value="0">없음</option>
											<option value="1">10분 전 미리 알림</option>
											<option value="2">30분 전 미리 알림</option>
											<option value="3">1 시간 전 미리 알림</option>
											<option value="4">2 시간 전 미리 알림</option>
											<option value="5">3 시간 전 미리 알림</option>
											<option value="6">1일 전 미리 알림</option>
											<option value="7">2일 전 미리 알림</option>
											<option value="8">7일 전 미리 알림</option></select>
									</div>
								</li>
